...
export function CurrentAuction({ auction, auctionState, onBid, onClose }: CurrentAuctionProps) {
                ...
                <Card className="bg-base-100 relative overflow-hidden">
                    ...
                    <div className="p-6 space-y-6">
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center justify-between">
                                    <div className="flex-1">
                                        <p className="text-sm text-base-content/60 mb-1">Продается</p>
                                        <h3 className="text-xl font-bold text-base-content">{cell.name}</h3>
                                    </div>
                                    {cell.color && (
                                        <div className={`w-16 h-16 ${getColorClass(cell.color)} rounded-lg shadow-lg`} />
                                    )}
                                </div>

                                <div className="grid grid-cols-2 gap-4">
                                    <div className="bg-base-200 rounded-lg p-3">
                                        <p className="text-xs text-base-content/60 mb-1">Базовая цена</p>
                                    ...
                                    <div className="bg-base-200 rounded-lg p-3">
                                        <p className="text-xs text-base-content/60 mb-1">Базовая рента</p>
                                        <p className="text-lg font-semibold text-base-content flex items-center gap-1">
                        ...
                        <div className="bg-gradient-to-r from-orange-500/20 to-red-500/20 border border-orange-500/30 rounded-lg p-4">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-sm text-base-content/80">Осталось времени</span>
                                </div>
                                <motion.div
                                    animate={timeLeft < 10 ? {
                                        scale: [1, 1.1, 1],
                                    ...
                                    className={`text-2xl font-bold ${timeLeft < 10 ? 'text-error' : 'text-warning'}`}
                                >
                                    {formatTime(timeLeft)}
                                </motion.div>
                            </div>
                        ...
                        <div className="bg-success/10 border border-success/30 rounded-lg p-4 flex items-center justify-between">
                            <div >
                                <p className="text-sm text-base-content/60 mb-1">Текущая ставка</p>
                                <motion.p
                        ...
                        <div className="space-y-3">
                            <div className="flex gap-2">
                                ...
                                <Button
                                    onClick={handleBid}
                                    disabled={bidAmount <= auction.currentBid || timeLeft === 0}
                                    variant="success"
                                    className="gap-2"
                                >

...
import { createPlayer, getPlayerById, getPlayerByName } from "../services/playerService.js";
import { getToken, setCookie, verifyToken } from "../utils/jwt.js";
import { createAuthResponse, validateAuthData, verifyPassword } from "../utils/authHelpers.js";
...
export const refreshToken = async (req: Request, res: Response) => {
    try {
        ...
        const { accessToken, refreshToken: newRefreshToken } = await getToken(decoded.id, decoded.name);
